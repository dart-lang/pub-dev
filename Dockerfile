...
RUN /project/tool/setup-dart.sh /tool/preview https://storage.googleapis.com/dart-archive/channels/beta/release/2.15.0-268.8.beta/sdk/dartsdk-linux-x64-release.zip

# Setup analysis Flutter SDKs
RUN /project/tool/setup-flutter.sh /tool/stable 2.5.3
RUN /project/tool/setup-flutter.sh /tool/preview 2.8.0-3.1.pre
