...
RUN /project/app/script/setup-dart.sh /tool/preview https://storage.googleapis.com/dart-archive/channels/stable/raw/2.13.3/sdk/dartsdk-linux-x64-release.zip
