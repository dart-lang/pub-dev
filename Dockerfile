...
RUN /project/app/script/setup-dart.sh /tool/stable https://storage.googleapis.com/dart-archive/channels/stable/raw/2.14.2/sdk/dartsdk-linux-x64-release.zip
...
RUN /project/app/script/setup-flutter.sh /tool/stable 2.5.1
