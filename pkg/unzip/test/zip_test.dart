...
void main() {
  ...
  test('TestCVE202127919', () {
    final data = Uint8List.fromList([
      ...
      0x00, 0x00, 0x00, 0x00, // Time/Date
      0x00, 0x00, 0x00, 0x00, // CRC32 (Zero, bit 3 set)
      0x00, 0x00, 0x00, 0x00, // Compressed Size (Zero, bit 3 set)
      0x00, 0x00, 0x00, 0x00, // Uncompressed Size (Zero, bit 3 set)
      0x0b, 0x00, // Filename length (11)
      0x00, 0x00, // Extra field length (0)
      // Filename: ../test.txt
      0x2e, 0x2e, 0x2f, 0x74, 0x65, 0x73, 0x74, 0x2e, 0x74, 0x78, 0x74,
      // Compressed Data
      0x0a, 0xc9, 0xc8, 0x2c, 0x56, 0xc8, 0x2c, 0x56, 0x48, 0x54, 0x28,
      0x49, 0x2d, 0x2e, 0x51, 0x28, 0x49, 0xad, 0x28, 0x51, 0x48, 0xcb,
      0xcc, 0x49, 0xd5, 0xe3, 0x02, 0x04, 0x00, 0x00, 0xff, 0xff,
      // Data Descriptor
      0x50, 0x4b, 0x07, 0x08, // Signature
      0xc0, 0xd7, 0xed, 0xc3, // CRC32
      0x20, 0x00, 0x00, 0x00, // Compressed Size (32)
      0x1a, 0x00, 0x00, 0x00, // Uncompressed Size (26)
      // Central Directory Header
      0x50, 0x4b, 0x01, 0x02, // Signature
      0x14, 0x00, 0x14, 0x00, // Creator/Reader Version
      0x08, 0x00, 0x08, 0x00, // Flags/Method
      0x00, 0x00, 0x00, 0x00, // Time/Date
      0xc0, 0xd7, 0xed, 0xc3, // CRC32
      0x20, 0x00, 0x00, 0x00, // Compressed Size
      0x1a, 0x00, 0x00, 0x00, // Uncompressed Size
      0x0b, 0x00, 0x00, 0x00, // Filename/Extra length
      0x00, 0x00, // Comment length
      0x00, 0x00, // Disk start
      0x00, 0x00, // Internal attrs
      0x00, 0x00, 0x00, 0x00, // External attrs
      ...
      0x01, 0x00, // Records this disk
      0x01, 0x00, // Records total
      0x39, 0x00, 0x00, 0x00, // Dir size (57)
      0x59, 0x00, 0x00, 0x00, // Dir offset (89)
      0x00, 0x00, // Comment length
    ]);
  ...
  test('TestCVE202133196', () {
    final data = Uint8List.fromList([
      ...
      0x50, 0x4b, 0x03, 0x04, // Signature
      0x14, 0x00, // Version needed
      0x08, 0x08, // Flags (bit 3 and 11 set)
      0x08, 0x00, // Compression Method (Deflate)
      0x00, 0x00, 0x00, 0x00, // Time/Date
      0x00, 0x00, 0x00, 0x00, // CRC32 (Zero, bit 3 set)
      0x00, 0x00, 0x00, 0x00, // Compressed Size (Zero, bit 3 set)
      0x00, 0x00, 0x00, 0x00, // Uncompressed Size (Zero, bit 3 set)
      0x03, 0x00, // Filename length (3)
      0x00, 0x00, // Extra field length (0)
      // Filename bytes
      0x01, 0x02, 0x03,
      // Compressed Data
      0x62, 0x61, 0x65, 0x03, 0x04, 0x00, 0x00, 0xff, 0xff,
      // Data Descriptor
      0x50, 0x4b, 0x07, 0x08, // Signature
      0xbe, 0x20, 0x5c, 0x6c, // CRC32
      0x09, 0x00, 0x00, 0x00, // Compressed Size (9)
      ...
      0x00, 0x00, 0x00, 0x00, // Time/Date
      0xbe, 0x20, 0x5c, 0x6c, // CRC32
      0x09, 0x00, 0x00, 0x00, // Compressed Size
      0x03, 0x00, 0x00, 0x00, // Uncompressed Size
      0x03, 0x00, // Filename length
      0x00, 0x00, // Extra length
      0x00, 0x00, // Comment length
      0x00, 0x00, // Disk start
      0x00, 0x00, // Internal attrs
      ...
      0x50, 0x4b, 0x06, 0x06, // Signature
      0x2c, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // Size of record
      0x2d, 0x00, // Version made by
      0x2d, 0x00, // Version needed to extract
      0x00, 0x00, 0x00, 0x00, // Number of this disk
      0x00, 0x00, 0x00, 0x00, // Disk with start of central dir
      0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // Entries this disk
      0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // Entries total
      0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, // Size of central dir
      0x31, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // Offset of central dir
      // Zip64 End of Central Directory Locator
      0x50, 0x4b, 0x06, 0x07, // Signature
      0x00, 0x00, 0x00, 0x00, // Disk with start of zip64 end record
      0x6b, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // Relative offset
      0x01, 0x00, 0x00, 0x00, // Total number of disks
      // End of Central Directory Record
      0x50, 0x4b, 0x05, 0x06, // Signature
      0x00, 0x00, // Disk number
      0x00, 0x00, // Dir disk number
      0xff, 0xff, // Records this disk (0xffff)
      0xff, 0xff, // Records total (0xffff)
      0xff, 0xff, 0xff, 0xff, // Dir size (0xffffffff)
      0xff, 0xff, 0xff, 0xff, // Dir offset (0xffffffff)
      0x00, 0x00, // Comment length
    ]);
  ...
  test('TestCompressedDirectory', () async {
    ...
    final data = Uint8List.fromList([
      // Local File Header
      0x50, 0x4b, 0x03, 0x04, 0x14, 0x00, 0x08, 0x08, 0x08, 0x00, 0x49, 0x86, 0x81, 0x55, 0x00, 0x00,
      0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x09, 0x00, 0x04, 0x00, 0x4d, 0x45,
      0x54, 0x41, 0x2d, 0x49, 0x4e, 0x46, 0x2f, 0xfe, 0xca, 0x00, 0x00, 0x03, 0x00, 
      // Data Descriptor
      0x50, 0x4b, 0x07,
      0x08, 0x00, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
      // Local File Header
      0x50, 0x4b, 0x03,
      0x04, 0x14, 0x00, 0x08, 0x08, 0x08, 0x00, 0x49, 0x86, 0x81, 0x55, 0x00, 0x00, 0x00, 0x00, 0x00,
      ...
      0x04, 0x0a, 0x00, 0x45, 0xf4, 0x0c, 0x8d, 0x15, 0x34, 0xdc, 0xf3, 0xf3, 0xd3, 0x73, 0x52, 0x15,
      0x3c, 0xf3, 0x92, 0xf5, 0x34, 0x79, 0xb9, 0x78, 0xb9, 0x00, 
      // Data Descriptor
      0x50, 0x4b, 0x07, 0x08, 0x93, 0x7e,
      0x93, 0xaf, 0x3b, 0x00, 0x00, 0x00, 0x3c, 0x00, 0x00, 0x00, 
      // Central Directory Header
      0x50, 0x4b, 0x01, 0x02, 0x14, 0x00,
      0x14, 0x00, 0x08, 0x08, 0x08, 0x00, 0x49, 0x86, 0x81, 0x55, 0x00, 0x00, 0x00, 0x00, 0x02, 0x00,
      0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x09, 0x00, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
      0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x4d, 0x45, 0x54, 0x41, 0x2d, 0x49, 0x4e, 0x46,
      0x2f, 0xfe, 0xca, 0x00, 0x00, 
      // Central Directory Header
      0x50, 0x4b, 0x01, 0x02, 0x14, 0x00, 0x14, 0x00, 0x08, 0x08, 0x08,
      0x00, 0x49, 0x86, 0x81, 0x55, 0x93, 0x7e, 0x93, 0xaf, 0x3b, 0x00, 0x00, 0x00, 0x3c, 0x00, 0x00,
      0x00, 0x14, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x3d,
      0x00, 0x00, 0x00, 0x4d, 0x45, 0x54, 0x41, 0x2d, 0x49, 0x4e, 0x46, 0x2f, 0x4d, 0x41, 0x4e, 0x49,
      0x46, 0x45, 0x53, 0x54, 0x2e, 0x4d, 0x46, 
      // End of Central Directory Record
      0x50, 0x4b, 0x05, 0x06, 0x00, 0x00, 0x00, 0x00, 0x02,
      0x00, 0x02, 0x00, 0x7d, 0x00, 0x00, 0x00, 0xba, 0x00, 0x00, 0x00, 0x00, 0x00,
    ]);
    final reader = ZipReader(MemoryReader(data));
    await reader.init();
  ...
  test('TestBaseOffsetPlusOverflow', () async {
    final data = Uint8List.fromList([
      // Padding (spaces)
      ...
      0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20,
      0xff, 0xff, // Marker?
      0x20, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x20, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80,

      // Zip64 End of Central Directory Locator
      0x50, 0x4b, 0x06, 0x07, // Signature
      0x00, 0x00, 0x00, 0x00, 0x6b, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00,

      // End of Central Directory Record
      0x50, 0x4b, 0x05, 0x06, // Signature
      0x20, 0x20, 0x20, 0x20, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
      0x20, 0x00,
    ]);
    expect(() async {
      final reader = ZipReader(MemoryReader(data));
  ...
  test('TestInsecurePaths_Absolute', () async {
    final data = Uint8List.fromList([
      ...
      0x00, 0x00, // Flags
      0x00, 0x00, // Method
      0xb9, 0x6a, 0x9c, 0x5c, // Time/Date
      0xa9, 0x30, 0xc5, 0xfe, // CRC32
      0x07, 0x00, 0x00, 0x00, // Compressed Size (7)
      0x07, 0x00, 0x00, 0x00, // Uncompressed Size (7)
      0x04, 0x00, // Filename length (4)
      ...
      // Central Directory Header
      0x50, 0x4b, 0x01, 0x02, // Signature
      0x14, 0x03, // Creator Version
      0x14, 0x00, // Reader Version
      0x00, 0x00, // Flags
      0x00, 0x00, // Method
      0xb9, 0x6a, 0x9c, 0x5c, // Time/Date
      0xa9, 0x30, 0xc5, 0xfe, // CRC32
      0x07, 0x00, 0x00, 0x00, // Compressed Size
      0x07, 0x00, 0x00, 0x00, // Uncompressed Size
      0x04, 0x00, // Filename length
      0x00, 0x00, // Extra length
      0x00, 0x00, // Comment length
      0x00, 0x00, // Disk start
      0x00, 0x00, // Internal attrs
      0x00, 0x00, 0x00, 0x80, // External attrs
      0x01, 0x00, 0x00, 0x00, // Local header offset
      ...
      0x01, 0x00, // Records this disk
      0x01, 0x00, // Records total
      0x32, 0x00, 0x00, 0x00, // Dir size (50)
  ...
  test('TestInsecurePaths_Backslash', () async {
    final data = Uint8List.fromList([
      ...
      0x01, 0x00, // Records this disk
      0x01, 0x00, // Records total
      0x31, 0x00, 0x00, 0x00, // Dir size (49)
