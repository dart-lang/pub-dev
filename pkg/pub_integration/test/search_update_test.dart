    ...
    test('bulk tests', () async {
      ...
      await user.withBrowserPage((page) async {
        ...
        await page.takeScreenshots(
          ...
          prefix: 'listing-page/search-form',
        );
        ...
        expect(page.url, '$origin/packages?q=platform%3Aandroid+sdk%3Aflutter');
      ...
      await user.withBrowserPage((page) async {
        ...
        expect(
          await page.propertyValue('input[name="q"]', 'value'),
          'platform:android platform:web platform:ios pkg',
        );

        await page.waitAndClick(
          '#search-form-checkbox-platform-windows',
          waitForOneResponse: true,
        );
        await _waitOneSecond();
        expect(
      ...
      await user.withBrowserPage((page) async {
        ...
        await page.waitAndClick(
          '#search-form-checkbox-license-osi-approved',
          waitForOneResponse: true,
        );
        await _waitOneSecond();
      ...
      await user.withBrowserPage((page) async {
        ...
        expect(
          page.url,
          '$origin/packages?q=platform%3Aandroid+sdk%3Adart+pkg',
        );
      });
    });
