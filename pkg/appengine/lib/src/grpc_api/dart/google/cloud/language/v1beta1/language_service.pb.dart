...
///
library google.cloud.language.v1beta1_language_service;
...
class Sentiment extends GeneratedMessage {
  ...
  double get polarity => $_get(0, 1, null);
  void set polarity(double v) { $_setFloat(0, 1, v); }
  bool hasPolarity() => $_has(0, 1);
  void clearPolarity() => clearField(1);

  double get magnitude => $_get(1, 2, null);
  void set magnitude(double v) { $_setFloat(1, 2, v); }
  bool hasMagnitude() => $_has(1, 2);
  void clearMagnitude() => clearField(2);

  double get score => $_get(2, 3, null);
  void set score(double v) { $_setFloat(2, 3, v); }
  bool hasScore() => $_has(2, 3);
