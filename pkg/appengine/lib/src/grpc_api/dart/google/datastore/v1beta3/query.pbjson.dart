...
///
library google.datastore.v1beta3_query_pbjson;

const EntityResult$json = const {
  '1': 'EntityResult',
  '2': const [
    const {'1': 'entity', '3': 1, '4': 1, '5': 11, '6': '.google.datastore.v1beta3.Entity'},
...
const Query$json = const {
  '1': 'Query',
  '2': const [
    const {'1': 'projection', '3': 2, '4': 3, '5': 11, '6': '.google.datastore.v1beta3.Projection'},
    const {'1': 'kind', '3': 3, '4': 3, '5': 11, '6': '.google.datastore.v1beta3.KindExpression'},
    const {'1': 'filter', '3': 4, '4': 1, '5': 11, '6': '.google.datastore.v1beta3.Filter'},
    const {'1': 'order', '3': 5, '4': 3, '5': 11, '6': '.google.datastore.v1beta3.PropertyOrder'},
    const {'1': 'distinct_on', '3': 6, '4': 3, '5': 11, '6': '.google.datastore.v1beta3.PropertyReference'},
...
const Projection$json = const {
  '1': 'Projection',
  '2': const [
    const {'1': 'property', '3': 1, '4': 1, '5': 11, '6': '.google.datastore.v1beta3.PropertyReference'},
  ],
};
...
const PropertyOrder$json = const {
  ...
  '2': const [
    const {'1': 'property', '3': 1, '4': 1, '5': 11, '6': '.google.datastore.v1beta3.PropertyReference'},
    const {'1': 'direction', '3': 2, '4': 1, '5': 14, '6': '.google.datastore.v1beta3.PropertyOrder.Direction'},
  ],
...
const Filter$json = const {
  '1': 'Filter',
  '2': const [
    const {'1': 'composite_filter', '3': 1, '4': 1, '5': 11, '6': '.google.datastore.v1beta3.CompositeFilter'},
    const {'1': 'property_filter', '3': 2, '4': 1, '5': 11, '6': '.google.datastore.v1beta3.PropertyFilter'},
  ],
};
...
const CompositeFilter$json = const {
  '1': 'CompositeFilter',
  '2': const [
    const {'1': 'op', '3': 1, '4': 1, '5': 14, '6': '.google.datastore.v1beta3.CompositeFilter.Operator'},
    const {'1': 'filters', '3': 2, '4': 3, '5': 11, '6': '.google.datastore.v1beta3.Filter'},
  ],
...
const PropertyFilter$json = const {
  ...
  '2': const [
    const {'1': 'property', '3': 1, '4': 1, '5': 11, '6': '.google.datastore.v1beta3.PropertyReference'},
    const {'1': 'op', '3': 2, '4': 1, '5': 14, '6': '.google.datastore.v1beta3.PropertyFilter.Operator'},
    const {'1': 'value', '3': 3, '4': 1, '5': 11, '6': '.google.datastore.v1beta3.Value'},
  ],
...
const GqlQuery$json = const {
  ...
  '2': const [
    ...
    const {'1': 'named_bindings', '3': 5, '4': 3, '5': 11, '6': '.google.datastore.v1beta3.GqlQuery.NamedBindingsEntry'},
    const {'1': 'positional_bindings', '3': 4, '4': 3, '5': 11, '6': '.google.datastore.v1beta3.GqlQueryParameter'},
  ],
...
const GqlQuery_NamedBindingsEntry$json = const {
  ...
  '2': const [
    ...
    const {'1': 'value', '3': 2, '4': 1, '5': 11, '6': '.google.datastore.v1beta3.GqlQueryParameter'},
  ],
  '7': const {},
};
...
const QueryResultBatch$json = const {
  ...
  '2': const [
    ...
    const {'1': 'entity_result_type', '3': 1, '4': 1, '5': 14, '6': '.google.datastore.v1beta3.EntityResult.ResultType'},
    const {'1': 'entity_results', '3': 2, '4': 3, '5': 11, '6': '.google.datastore.v1beta3.EntityResult'},
    const {'1': 'end_cursor', '3': 4, '4': 1, '5': 12},
    const {'1': 'more_results', '3': 5, '4': 1, '5': 14, '6': '.google.datastore.v1beta3.QueryResultBatch.MoreResultsType'},
