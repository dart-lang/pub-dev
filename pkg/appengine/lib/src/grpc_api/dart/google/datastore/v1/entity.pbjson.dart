...
///
library google.datastore.v1_entity_pbjson;
...
const Key$json = const {
  '1': 'Key',
  '2': const [
    const {'1': 'partition_id', '3': 1, '4': 1, '5': 11, '6': '.google.datastore.v1.PartitionId'},
    const {'1': 'path', '3': 2, '4': 3, '5': 11, '6': '.google.datastore.v1.Key.PathElement'},
  ],
...
const ArrayValue$json = const {
  '1': 'ArrayValue',
  '2': const [
    const {'1': 'values', '3': 1, '4': 3, '5': 11, '6': '.google.datastore.v1.Value'},
  ],
};
...
const Value$json = const {
  ...
  '2': const [
    ...
    const {'1': 'key_value', '3': 5, '4': 1, '5': 11, '6': '.google.datastore.v1.Key'},
    ...
    const {'1': 'entity_value', '3': 6, '4': 1, '5': 11, '6': '.google.datastore.v1.Entity'},
    const {'1': 'array_value', '3': 9, '4': 1, '5': 11, '6': '.google.datastore.v1.ArrayValue'},
...
const Entity$json = const {
  '1': 'Entity',
  '2': const [
    const {'1': 'key', '3': 1, '4': 1, '5': 11, '6': '.google.datastore.v1.Key'},
    const {'1': 'properties', '3': 3, '4': 3, '5': 11, '6': '.google.datastore.v1.Entity.PropertiesEntry'},
  ],
