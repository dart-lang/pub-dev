...
class RetryInfo extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(_omitMessageNames ? '' : 'google.rpc'),
      createEmptyInstance: create)
    ..aOM<$51.Duration>(1, _omitFieldNames ? '' : 'retryDelay',
  ...
  @$pb.TagNumber(1)
  $51.Duration get retryDelay => $_getN(0);
  @$pb.TagNumber(1)
  set retryDelay($51.Duration v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(1)
  $51.Duration ensureRetryDelay() => $_ensure(0);
}
