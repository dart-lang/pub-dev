...
class PolicyRule extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$117.DenyRule>(2, _omitFieldNames ? '' : 'denyRule',
        subBuilder: $117.DenyRule.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(2)
  $117.DenyRule get denyRule => $_getN(1);
  @$pb.TagNumber(2)
  set denyRule($117.DenyRule v) {
    setField(2, v);
  }
  ...
  @$pb.TagNumber(2)
  $117.DenyRule ensureDenyRule() => $_ensure(1);
}
