...
class UpdateServiceMethod extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package:
          const $pb.PackageName(_omitMessageNames ? '' : 'google.appengine.v1'),
      createEmptyInstance: create)
    ..aOM<$10.UpdateServiceRequest>(1, _omitFieldNames ? '' : 'request',
        subBuilder: $10.UpdateServiceRequest.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(1)
  $10.UpdateServiceRequest get request => $_getN(0);
  @$pb.TagNumber(1)
  set request($10.UpdateServiceRequest v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(1)
  $10.UpdateServiceRequest ensureRequest() => $_ensure(0);
}
...
class CreateVersionMethod extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package:
          const $pb.PackageName(_omitMessageNames ? '' : 'google.appengine.v1'),
      createEmptyInstance: create)
    ..aOM<$10.CreateVersionRequest>(1, _omitFieldNames ? '' : 'request',
        subBuilder: $10.CreateVersionRequest.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(1)
  $10.CreateVersionRequest get request => $_getN(0);
  @$pb.TagNumber(1)
  set request($10.CreateVersionRequest v) {
    setField(1, v);
  }
  ...
  void clearRequest() => clearField(1);
  @$pb.TagNumber(1)
  $10.CreateVersionRequest ensureRequest() => $_ensure(0);
}
