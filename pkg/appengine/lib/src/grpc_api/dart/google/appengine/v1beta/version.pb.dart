...
import 'app_yaml.pb.dart' as $52;
import 'deploy.pb.dart' as $53;
...
class Version extends $pb.GeneratedMessage {
  factory Version({
    ...
    $core.Iterable<$52.UrlMap>? handlers,
    $core.Iterable<$52.ErrorHandler>? errorHandlers,
    $core.Iterable<$52.Library>? libraries,
    $52.ApiConfigHandler? apiConfig,
    $core.Map<$core.String, $core.String>? envVariables,
    $51.Duration? defaultExpiration,
    $52.HealthCheck? healthCheck,
    $core.String? nobuildFilesRegex,
    $53.Deployment? deployment,
    $core.String? versionUrl,
    EndpointsApiService? endpointsApiService,
    $52.ReadinessCheck? readinessCheck,
    $52.LivenessCheck? livenessCheck,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<$52.UrlMap>(100, _omitFieldNames ? '' : 'handlers', $pb.PbFieldType.PM,
        subBuilder: $52.UrlMap.create)
    ..pc<$52.ErrorHandler>(
        101, _omitFieldNames ? '' : 'errorHandlers', $pb.PbFieldType.PM,
        subBuilder: $52.ErrorHandler.create)
    ..pc<$52.Library>(
        102, _omitFieldNames ? '' : 'libraries', $pb.PbFieldType.PM,
        subBuilder: $52.Library.create)
    ..aOM<$52.ApiConfigHandler>(103, _omitFieldNames ? '' : 'apiConfig',
        subBuilder: $52.ApiConfigHandler.create)
    ...
    ..aOM<$52.HealthCheck>(106, _omitFieldNames ? '' : 'healthCheck',
        subBuilder: $52.HealthCheck.create)
    ..aOS(107, _omitFieldNames ? '' : 'nobuildFilesRegex')
    ..aOM<$53.Deployment>(108, _omitFieldNames ? '' : 'deployment',
        subBuilder: $53.Deployment.create)
    ...
    ..aOM<$52.ReadinessCheck>(112, _omitFieldNames ? '' : 'readinessCheck',
        subBuilder: $52.ReadinessCheck.create)
    ..aOM<$52.LivenessCheck>(113, _omitFieldNames ? '' : 'livenessCheck',
        subBuilder: $52.LivenessCheck.create)
  ...
  @$pb.TagNumber(100)
  $core.List<$52.UrlMap> get handlers => $_getList(20);

  ///  Custom static error pages. Limited to 10KB per page.
  ///
  ///  Only returned in `GET` requests if `view=FULL` is set.
  @$pb.TagNumber(101)
  $core.List<$52.ErrorHandler> get errorHandlers => $_getList(21);
  ...
  ///  Only returned in `GET` requests if `view=FULL` is set.
  @$pb.TagNumber(102)
  $core.List<$52.Library> get libraries => $_getList(22);
  ...
  ///  Only returned in `GET` requests if `view=FULL` is set.
  @$pb.TagNumber(103)
  $52.ApiConfigHandler get apiConfig => $_getN(23);
  @$pb.TagNumber(103)
  set apiConfig($52.ApiConfigHandler v) {
    setField(103, v);
  }
  ...
  @$pb.TagNumber(103)
  $52.ApiConfigHandler ensureApiConfig() => $_ensure(23);
  ...
  ///  Only returned in `GET` requests if `view=FULL` is set.
  @$pb.TagNumber(106)
  $52.HealthCheck get healthCheck => $_getN(26);
  @$pb.TagNumber(106)
  set healthCheck($52.HealthCheck v) {
    setField(106, v);
  }
  ...
  @$pb.TagNumber(106)
  $52.HealthCheck ensureHealthCheck() => $_ensure(26);
  ...
  ///  Only returned in `GET` requests if `view=FULL` is set.
  @$pb.TagNumber(108)
  $53.Deployment get deployment => $_getN(28);
  @$pb.TagNumber(108)
  set deployment($53.Deployment v) {
    setField(108, v);
  }
  ...
  @$pb.TagNumber(108)
  $53.Deployment ensureDeployment() => $_ensure(28);
  ...
  ///  Only returned in `GET` requests if `view=FULL` is set.
  @$pb.TagNumber(112)
  $52.ReadinessCheck get readinessCheck => $_getN(31);
  @$pb.TagNumber(112)
  set readinessCheck($52.ReadinessCheck v) {
    setField(112, v);
  }
  ...
  @$pb.TagNumber(112)
  $52.ReadinessCheck ensureReadinessCheck() => $_ensure(31);
  ...
  ///  Only returned in `GET` requests if `view=FULL` is set.
  @$pb.TagNumber(113)
  $52.LivenessCheck get livenessCheck => $_getN(32);
  @$pb.TagNumber(113)
  set livenessCheck($52.LivenessCheck v) {
    setField(113, v);
  }
  ...
  @$pb.TagNumber(113)
  $52.LivenessCheck ensureLivenessCheck() => $_ensure(32);
