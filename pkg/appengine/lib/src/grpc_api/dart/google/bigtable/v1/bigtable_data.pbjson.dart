...
///
library google.bigtable.v1_bigtable_data_pbjson;

const Row$json = const {
  '1': 'Row',
  '2': const [
    const {'1': 'key', '3': 1, '4': 1, '5': 12},
    const {'1': 'families', '3': 2, '4': 3, '5': 11, '6': '.google.bigtable.v1.Family'},
  ],
};
...
const Family$json = const {
  ...
  '2': const [
    ...
    const {'1': 'columns', '3': 2, '4': 3, '5': 11, '6': '.google.bigtable.v1.Column'},
  ],
};
...
const Column$json = const {
  ...
  '2': const [
    ...
    const {'1': 'cells', '3': 2, '4': 3, '5': 11, '6': '.google.bigtable.v1.Cell'},
  ],
};
...
const RowRange$json = const {
  '1': 'RowRange',
  '2': const [
    const {'1': 'start_key', '3': 2, '4': 1, '5': 12},
    const {'1': 'end_key', '3': 3, '4': 1, '5': 12},
  ],
};
...
const RowSet$json = const {
  ...
  '2': const [
    ...
    const {'1': 'row_ranges', '3': 2, '4': 3, '5': 11, '6': '.google.bigtable.v1.RowRange'},
  ],
};
...
const ColumnRange$json = const {
  ...
  '2': const [
    ...
    const {'1': 'start_qualifier_inclusive', '3': 2, '4': 1, '5': 12},
    const {'1': 'start_qualifier_exclusive', '3': 3, '4': 1, '5': 12},
    const {'1': 'end_qualifier_inclusive', '3': 4, '4': 1, '5': 12},
    const {'1': 'end_qualifier_exclusive', '3': 5, '4': 1, '5': 12},
  ],
};
...
const ValueRange$json = const {
  '1': 'ValueRange',
  '2': const [
    const {'1': 'start_value_inclusive', '3': 1, '4': 1, '5': 12},
    const {'1': 'start_value_exclusive', '3': 2, '4': 1, '5': 12},
    const {'1': 'end_value_inclusive', '3': 3, '4': 1, '5': 12},
    const {'1': 'end_value_exclusive', '3': 4, '4': 1, '5': 12},
  ],
};
...
const RowFilter$json = const {
  '1': 'RowFilter',
  '2': const [
    const {'1': 'chain', '3': 1, '4': 1, '5': 11, '6': '.google.bigtable.v1.RowFilter.Chain'},
    const {'1': 'interleave', '3': 2, '4': 1, '5': 11, '6': '.google.bigtable.v1.RowFilter.Interleave'},
    const {'1': 'condition', '3': 3, '4': 1, '5': 11, '6': '.google.bigtable.v1.RowFilter.Condition'},
    ...
    const {'1': 'column_range_filter', '3': 7, '4': 1, '5': 11, '6': '.google.bigtable.v1.ColumnRange'},
    const {'1': 'timestamp_range_filter', '3': 8, '4': 1, '5': 11, '6': '.google.bigtable.v1.TimestampRange'},
    const {'1': 'value_regex_filter', '3': 9, '4': 1, '5': 12},
    const {'1': 'value_range_filter', '3': 15, '4': 1, '5': 11, '6': '.google.bigtable.v1.ValueRange'},
...
const RowFilter_Chain$json = const {
  '1': 'Chain',
  '2': const [
    const {'1': 'filters', '3': 1, '4': 3, '5': 11, '6': '.google.bigtable.v1.RowFilter'},
  ],
};
...
const RowFilter_Condition$json = const {
  '1': 'Condition',
  '2': const [
    const {'1': 'predicate_filter', '3': 1, '4': 1, '5': 11, '6': '.google.bigtable.v1.RowFilter'},
    const {'1': 'true_filter', '3': 2, '4': 1, '5': 11, '6': '.google.bigtable.v1.RowFilter'},
    const {'1': 'false_filter', '3': 3, '4': 1, '5': 11, '6': '.google.bigtable.v1.RowFilter'},
  ],
};
...
const Mutation$json = const {
  '1': 'Mutation',
  '2': const [
    const {'1': 'set_cell', '3': 1, '4': 1, '5': 11, '6': '.google.bigtable.v1.Mutation.SetCell'},
    const {'1': 'delete_from_column', '3': 2, '4': 1, '5': 11, '6': '.google.bigtable.v1.Mutation.DeleteFromColumn'},
    const {'1': 'delete_from_family', '3': 3, '4': 1, '5': 11, '6': '.google.bigtable.v1.Mutation.DeleteFromFamily'},
    const {'1': 'delete_from_row', '3': 4, '4': 1, '5': 11, '6': '.google.bigtable.v1.Mutation.DeleteFromRow'},
  ],
...
const Mutation_DeleteFromColumn$json = const {
  ...
  '2': const [
    const {'1': 'family_name', '3': 1, '4': 1, '5': 9},
    const {'1': 'column_qualifier', '3': 2, '4': 1, '5': 12},
    const {'1': 'time_range', '3': 3, '4': 1, '5': 11, '6': '.google.bigtable.v1.TimestampRange'},
  ],
};
