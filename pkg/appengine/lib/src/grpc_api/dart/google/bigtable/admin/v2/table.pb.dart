...
///
library google.bigtable.admin.v2_table;
...
class Table extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('Table')
    ...
    ..e/*<Table_TimestampGranularity>*/(4, 'granularity', PbFieldType.OE, Table_TimestampGranularity.TIMESTAMP_GRANULARITY_UNSPECIFIED, Table_TimestampGranularity.valueOf)
    ..hasRequiredFields = false
  ;
  ...
  List<Table_ColumnFamiliesEntry> get columnFamilies => $_get(1, 3, null);

  Table_TimestampGranularity get granularity => $_get(2, 4, null);
  void set granularity(Table_TimestampGranularity v) { setField(4, v); }
  bool hasGranularity() => $_has(2, 4);
...
class ColumnFamily extends GeneratedMessage {
  ...
  GcRule get gcRule => $_get(0, 1, null);
  void set gcRule(GcRule v) { setField(1, v); }
  bool hasGcRule() => $_has(0, 1);
