...
class DataStoreV3ServiceClientRPCStub {
  ...
  dumpProtoMessage(List<int> message) {
    try {
      throw 'stack trace capture';
    } catch (e,s) {
      print('=============================================');
      print('DataStoreV3ServiceClientRPCStub could not decode the following '
            'protobuf message:');
      print('--------------------------------------------');
      print(message.map((int byte) => byte.toRadixString(16)).join(', '));
      print('--------------------------------------------');
      print('Stack:\n$s');
      print('=============================================');
    }
