...
const acceptedRuntimeVersions = <String>[
  '2021.03.12', // The current [runtimeVersion].
  '2021.03.03',
  '2021.03.02',
  '2021.02.24',
];
...
final String toolStableFlutterSdkVersion = '2.0.1';
final String toolPreviewDartSdkVersion = '2.12.1';
final String toolPreviewFlutterSdkVersion = '2.0.1';
...
final String dartdocVersion = '0.40.0';
