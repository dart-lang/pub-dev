...
Configuration _$ConfigurationFromJson(Map json) {
  return $checkedNew('Configuration', json, () {
    ...
    final val = Configuration(
      ...
      dartdocStorageBucketName: $checkedConvert(
          json, 'dartdocStorageBucketName', (v) => v as String?),
      popularityDumpBucketName: $checkedConvert(
          json, 'popularityDumpBucketName', (v) => v as String?),
      searchSnapshotBucketName: $checkedConvert(
          json, 'searchSnapshotBucketName', (v) => v as String?),
      searchServicePrefix:
      ...
      adminAudience:
          $checkedConvert(json, 'adminAudience', (v) => v as String?),
      gmailRelayServiceAccount: $checkedConvert(
          json, 'gmailRelayServiceAccount', (v) => v as String?),
      ...
      primarySiteUri: $checkedConvert(
          json, 'primarySiteUri', (v) => Uri.parse(v as String)),
      admins: $checkedConvert(
          json,
          'admins',
          (v) => (v as List<dynamic>?)
              ?.map(
                  (e) => AdminId.fromJson(Map<String, dynamic>.from(e as Map)))
              .toList()),
    );
    return val;
  });
