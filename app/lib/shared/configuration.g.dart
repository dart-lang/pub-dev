...
Configuration _$ConfigurationFromJson(
  ...
  final val = Configuration(
    ...
    downloadCountsBucketName: $checkedConvert(
      'downloadCountsBucketName',
      (v) => v as String?,
    ),
    searchSnapshotBucketName: $checkedConvert(
      'searchSnapshotBucketName',
      (v) => v as String?,
    ),
    exportedApiBucketName: $checkedConvert(
      'exportedApiBucketName',
      (v) => v as String?,
    ),
    maxTaskInstances: $checkedConvert(
      'maxTaskInstances',
      (v) => (v as num).toInt(),
    ),
    maxTaskRunHours: $checkedConvert(
      'maxTaskRunHours',
      (v) => (v as num).toInt(),
    ),
    taskResultBucketName: $checkedConvert(
      'taskResultBucketName',
      (v) => v as String?,
    ),
    taskWorkerImage: $checkedConvert('taskWorkerImage', (v) => v as String?),
    taskWorkerProject: $checkedConvert(
      'taskWorkerProject',
      (v) => v as String?,
    ),
    taskWorkerNetwork: $checkedConvert(
      'taskWorkerNetwork',
      (v) => v as String?,
    ),
    cosImage: $checkedConvert('cosImage', (v) => v as String?),
    taskWorkerServiceAccount: $checkedConvert(
      'taskWorkerServiceAccount',
      (v) => v as String?,
    ),
    searchServicePrefix: $checkedConvert(
      'searchServicePrefix',
      (v) => v as String,
    ),
    ...
    storageBaseUrl: $checkedConvert('storageBaseUrl', (v) => v as String?),
    pubClientAudience: $checkedConvert(
      'pubClientAudience',
      (v) => v as String?,
    ),
    pubServerAudience: $checkedConvert(
      'pubServerAudience',
      (v) => v as String?,
    ),
    externalServiceAudience: $checkedConvert(
      'externalServiceAudience',
      (v) => v as String?,
    ),
    gmailRelayServiceAccount: $checkedConvert(
      'gmailRelayServiceAccount',
      (v) => v as String?,
    ),
    ...
    primaryApiUri: $checkedConvert(
      'primaryApiUri',
      (v) => v == null ? null : Uri.parse(v as String),
    ),
    primarySiteUri: $checkedConvert(
      'primarySiteUri',
    ...
    admins: $checkedConvert(
      'admins',
      (v) => (v as List<dynamic>?)
          ?.map((e) => AdminId.fromJson(Map<String, dynamic>.from(e as Map)))
          .toList(),
    ),
    defaultServiceBaseUrl: $checkedConvert(
      'defaultServiceBaseUrl',
      (v) => v as String,
    ),
    tools: $checkedConvert(
      ...
      (v) => v == null
          ? null
          : ToolsConfiguration.fromJson(Map<String, dynamic>.from(v as Map)),
    ),
    rateLimits: $checkedConvert(
      'rateLimits',
      (v) => (v as List<dynamic>?)
          ?.map((e) => RateLimit.fromJson(Map<String, dynamic>.from(e as Map)))
          .toList(),
    ),
    imageProxyHmacKeyVersion: $checkedConvert(
      'imageProxyHmacKeyVersion',
      (v) => v as String?,
    ),
    imageProxyServiceBaseUrl: $checkedConvert(
      'imageProxyServiceBaseUrl',
      (v) => v as String?,
    ),
  );
...
AdminId _$AdminIdFromJson(Map json) => $checkedCreate('AdminId', json, (
  ...
  $checkKeys(json, allowedKeys: const ['oauthUserId', 'email', 'permissions']);
  final val = AdminId(
...
ToolsConfiguration _$ToolsConfigurationFromJson(Map<String, dynamic> json) =>
    $checkedCreate('ToolsConfiguration', json, ($checkedConvert) {
      $checkKeys(
        json,
        allowedKeys: const [
          'stableDartSdkPath',
      ...
      final val = ToolsConfiguration(
        stableDartSdkPath: $checkedConvert(
          'stableDartSdkPath',
          (v) => v as String?,
        ),
        stableFlutterSdkPath: $checkedConvert(
          'stableFlutterSdkPath',
          (v) => v as String?,
        ),
        previewDartSdkPath: $checkedConvert(
          'previewDartSdkPath',
          (v) => v as String?,
        ),
        previewFlutterSdkPath: $checkedConvert(
          'previewFlutterSdkPath',
          (v) => v as String?,
        ),
      );
...
RateLimit _$RateLimitFromJson(Map<String, dynamic> json) =>
    $checkedCreate('RateLimit', json, ($checkedConvert) {
      $checkKeys(
        json,
      ...
      final val = RateLimit(
        ...
        scope: $checkedConvert(
          'scope',
          (v) => $enumDecode(_$RateLimitScopeEnumMap, v),
        ),
