...
class PackageRejectedException extends ResponseException {
  ...
  PackageRejectedException.archiveTooLarge(int limit)
    : super._(400, 'PackageRejected', 'Package archive exceeded $limit bytes.');
...
class AuthenticationException extends ResponseException {
  AuthenticationException._(String message, {Map<String, Object>? headers})
    : super._(
        401,
        'MissingAuthentication',
        message,
        headers: {..._wwwAuthenticateHeaders(message), ...?headers},
      );
  ...
  factory AuthenticationException.failed([String? message]) =>
      AuthenticationException._(
        ['Authentication failed.', if (message != null) message].join(' '),
      );
  ...
  }) => AuthenticationException._('Browser cookie invalid.', headers: headers);
...
class AuthorizationException extends ResponseException {
  ...
  factory AuthorizationException.userIsNotDomainOwner(
    String domain,
  ) => AuthorizationException._(
    [
  ...
  factory AuthorizationException.githubActionIssue(
    String reason,
  ) => AuthorizationException._(
  ...
  /// be authorized with the current configuration.
  factory AuthorizationException.serviceAccountPublishingIssue(
    String reason,
  ) => AuthorizationException._(
...
class ScopeNeededException extends ResponseException {
  ScopeNeededException({required String location, required String message})
    : super._(401, 'ScopeNeeded', message, body: {'go': location});
}
...
Map<String, String> _wwwAuthenticateHeaders(String message) {
  ...
  final escaped = String.fromCharCodes(
    message
        .replaceAll('"', "'")
        .runes
