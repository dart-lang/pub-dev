...
class AuditLogRecord extends db.ExpandoModel<String> {
  ...
  /// [User.id] of the user who initiated / authorized the recorded action.
  ///
  ...
  /// List of [User.id] for the users involved in this record.
  ///
  ...
  @db.StringListProperty(required: true)
  List<String> users;
