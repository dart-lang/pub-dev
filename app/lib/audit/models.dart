...
final _shortTermExpireThreshold = auditLogRecordExpiresInFarFuture.subtract(
  Duration(days: 1),
);
...
class AuditLogRecord extends db.ExpandoModel<String> {
  ...
  static Future<AuditLogRecord> packageVersionOptionsUpdated({
    ...
    return _checkRateLimit(
      AuditLogRecord._init()
        ...
        ..agent = agent.agentId
        ..summary =
            '`${agent.displayId}` updated $optionsStr of '
  ...
  static String _summaryForPublishing({
    ...
    if (uploader is AuthenticatedGitHubAction) {
      ...
      return [...prefix, ' was published by `${uploader.displayId}`.'].join();
    }
  }
  ...
  static Future<AuditLogRecord> publisherContactInviteExpired({
    ...
    final fromUserId = fromAgent != null && looksLikeUserId(fromAgent)
        ? fromAgent
        : null;
    return _checkRateLimit(
      AuditLogRecord._init()
        ...
        ..agent = KnownAgents.pubSupport
        ..summary =
            'Contact invite for publisher `$publisherId` expired, '
  ...
  static Future<AuditLogRecord> publisherCreated({
    ...
    return _checkRateLimit(
      AuditLogRecord._init()
        ...
        ..data = {'publisherId': publisherId, 'user': user.email}
        ..users = [user.userId]
        ..packages = []
        ..packageVersions = []
        ..publishers = [publisherId],
  ...
  static Future<AuditLogRecord> publisherMemberInviteExpired({
    ...
    return _checkRateLimit(
      AuditLogRecord._init()
        ...
        ..agent = KnownAgents.pubSupport
        ..summary =
            'Member invite for publisher `$publisherId` expired, '
  ...
  static Future<AuditLogRecord> uploaderInviteAccepted({
    ...
    return _checkRateLimit(
      AuditLogRecord._init()
        ...
        ..data = {'package': package, 'user': user.email}
        ..users = [user.userId]
        ..packages = [package]
        ..packageVersions = []
        ..publishers = [],
  ...
  static Future<AuditLogRecord> uploaderInviteExpired({
    ...
    return _checkRateLimit(
      AuditLogRecord._init()
        ...
        ..agent = KnownAgents.pubSupport
        ..summary =
            'Uploader invite for package `$package` expired, '
