...
) => $checkedCreate('CanonicalTopicFileContent', json, ($checkedConvert) {
  $checkKeys(json, allowedKeys: const ['topics']);
...
CanonicalTopic _$CanonicalTopicFromJson(Map<String, dynamic> json) =>
    $checkedCreate('CanonicalTopic', json, ($checkedConvert) {
      $checkKeys(json, allowedKeys: const ['topic', 'description', 'aliases']);
