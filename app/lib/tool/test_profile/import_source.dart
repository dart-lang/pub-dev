...
class _AutoGeneratedImportSource implements ImportSource {
  ...
  Future<List<int>> getArchiveBytes(
    ...
    final hasHomepage = metadata['has-homepage'] != '0';
    final hasRepository = hasher('hasRepository', max: 20) > 0;
    final isLegacy = metadata['is-legacy'] == '1';

    final sdkConstraint = isLegacy ? '>=1.12.0 <2.0.0' : '^3.0.0';

    final isFlutter =
        package.startsWith('flutter_') || metadata['is-flutter'] == '1';
    ...
    if (metadata['readme-markdown-demo'] == '1') {
