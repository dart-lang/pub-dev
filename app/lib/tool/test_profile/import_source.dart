...
abstract class ImportSource {
  ...
  Future<List<int>> getArchiveBytes(
    ...
    /// Additional information to influence automatically generated source codes.
...
class _AutoGeneratedImportSource implements ImportSource {
  ...
  Future<List<int>> getArchiveBytes(
    ...
    final hasHomepage = parameters['has-homepage'] != '0';
    final hasRepository = hasher('hasRepository', max: 20) > 0;
    final isLegacy = parameters['is-legacy'] == '1';

    final sdkConstraint = isLegacy ? '>=1.12.0 <2.0.0' : '^3.0.0';

    final isFlutter =
        package.startsWith('flutter_') || parameters['is-flutter'] == '1';
    ...
    final readmeContent = StringBuffer('# $package\n\nAwesome package.');
    if (parameters['readme-markdown-demo'] == '1') {
      readmeContent.writeln('\n\n# Markdown demo\n\n');
      // TODO: Create example content with basic markdown syntax
      // TODO: Create example content with GitHub markdown extensions
    }

    archive.addFile('pubspec.yaml', pubspec);
    archive.addFile('README.md', readmeContent.toString());
