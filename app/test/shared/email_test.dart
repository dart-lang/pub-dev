...
//      expect(isValidEmail('"a b"@example.com'), true);
    ...
    test('rejected e-mail', () {
      ...
      expect(isValidEmail('a a@b.com'), false);
      expect(isValidEmail('a@ b.com'), false);
      expect(isValidEmail('a@b .com'), false);
      expect(isValidEmail('a@b. com'), false);
      expect(isValidEmail('a@'), false);
      ...
      expect(isValidEmail('@example.com'), false);
//      expect(isValidEmail('.@example.com'), false);
//      expect(isValidEmail('.a@example.com'), false);
//      expect(isValidEmail('a.@example.com'), false);
//      expect(isValidEmail('a..b@example.com'), false);
//      expect(isValidEmail('@@example.com'), false);
...
//      expect(isValidEmail('invalid:email@example.com'), false);
//      expect(isValidEmail('email@example.com.'), false);
//      expect(isValidEmail('email@example-.com'), false);
//      expect(isValidEmail('email@-example.com'), false);
//      expect(isValidEmail('email@-.com'), false);
      expect(isValidEmail('email@example_com'), false);
//      expect(isValidEmail('email@example.com@'), false);
//      expect(isValidEmail('email@example+domain.com'), false);
//      expect(isValidEmail('email@example+.com'), false);
//      expect(isValidEmail('email@mailto:example.com'), false);
    });
  });
