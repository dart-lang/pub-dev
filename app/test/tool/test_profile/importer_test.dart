  ...
  group('importer tests', () {
    testWithServices(
      ...
      () async {
        ...
        expect(users.single.userId, 'dev-at-example-dot-com-uuid');
        ...
        expect(versions.single.uploader, 'dev-at-example-dot-com-uuid');
        ...
        expect(members.single.userId, 'dev-at-example-dot-com-uuid');
