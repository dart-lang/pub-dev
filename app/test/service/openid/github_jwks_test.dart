...
import 'package:pub_dev/service/openid/github_jwks.dart';
...
void main() {
  testWithProfile('GitHub key list', fn: () async {
    final list = await fetchGithubOpenIdWebKeyList();
    expect(list.keys, isNotEmpty);
    final rsaKeys = list.keys.where((key) => key.kty == 'RSA').toList();
