...
void main() {
  testWithProfile('id-token test', fn: () async {
    ...
    if (actionsIdTokenRequestUrl.isEmpty) {
      // The test relies on the existence of the `ACTIONS_ID_TOKEN_REQUEST_URL`,
      // which may not be present in pull-requests coming from forked repositories.
      return;
    }
