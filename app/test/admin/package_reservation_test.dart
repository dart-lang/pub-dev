...
void main() {
  group('Reserve package', () {
    Future<void> _reserve(String package, {List<String>? emails}) async {
    ...
    testWithProfile(
      'cannot reserve existing package',
      fn: () async {
    ...
    testWithProfile(
      'cannot reserve ModeratedPackage',
      fn: () async {
    ...
    testWithProfile(
      'prevents non-whitelisted publishing',
      fn: () async {
        await _reserve('pkg');
    ...
    testWithProfile(
      'no longer allows Dart-team exemption',
      fn: () async {
        await _reserve('pkg');
