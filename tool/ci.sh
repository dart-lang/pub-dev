  ...
  if [[ ${EXIT_CODE} -ne 0 ]]; then
    ...
    for TASK in "$@"; do
      ...
      format)
        ...
        ;;
      test_00)
        echo 'dart test -P build-only -j 1'
        dart test -P build-only -j 1 || EXIT_CODE=$?
        ;;
      test_01)
      ...
      test_09)
        ...
        ;;
      test_10)
        echo 'dart test -j1 --run-skipped `find test -name "*_test\\.dart" | sort | sed -n '0~7p'`'
        dart test -j1 --run-skipped `find test -name "*_test\\.dart" | sort | sed -n '0~7p'` || EXIT_CODE=$?
        ;;
      test_11)
        echo 'dart test -j1 --run-skipped `find test -name "*_test\\.dart" | sort | sed -n '1~7p'`'
        dart test -j1 --run-skipped `find test -name "*_test\\.dart" | sort | sed -n '1~7p'` || EXIT_CODE=$?
        ;;
      test_12)
        echo 'dart test -j1 --run-skipped `find test -name "*_test\\.dart" | sort | sed -n '2~7p'`'
        dart test -j1 --run-skipped `find test -name "*_test\\.dart" | sort | sed -n '2~7p'` || EXIT_CODE=$?
        ;;
      test_13)
        echo 'dart test -j1 --run-skipped `find test -name "*_test\\.dart" | sort | sed -n '3~7p'`'
        dart test -j1 --run-skipped `find test -name "*_test\\.dart" | sort | sed -n '3~7p'` || EXIT_CODE=$?
        ;;
      test_14)
        echo 'dart test -j1 --run-skipped `find test -name "*_test\\.dart" | sort | sed -n '4~7p'`'
        dart test -j1 --run-skipped `find test -name "*_test\\.dart" | sort | sed -n '4~7p'` || EXIT_CODE=$?
        ;;
      test_15)
        echo 'dart test -j1 --run-skipped `find test -name "*_test\\.dart" | sort | sed -n '5~7p'`'
        dart test -j1 --run-skipped `find test -name "*_test\\.dart" | sort | sed -n '5~7p'` || EXIT_CODE=$?
        ;;
      test_16)
        echo 'dart test -j1 --run-skipped `find test -name "*_test\\.dart" | sort | sed -n '6~7p'`'
        dart test -j1 --run-skipped `find test -name "*_test\\.dart" | sort | sed -n '6~7p'` || EXIT_CODE=$?
        ;;
      test_17)
