...
RUN /project/tool/setup-dart.sh /tool/preview 3.0.0

# Setup analysis Flutter SDKs
RUN /project/tool/setup-flutter.sh /tool/stable 3.10.0-1.5.pre
RUN /project/tool/setup-flutter.sh /tool/preview 3.10.0-1.5.pre
