 ...
 * Bump runtimeVersion to `2026.08.13`.
 * Upgraded runtime Dart SDK to `3.13.0`
 * Upgraded stable Dart analysis SDK to `3.13.0`
 * Upgraded stable Flutter analysis SDK to `3.47.0`.
 * Upgraded dependencies.
 * Note: started to mirror `neat_periodic_task` status data into SQL.
 ...
 * Upgraded stable Flutter analysis SDK to `3.44.3`.
 * Upgraded pana to `0.23.13`.
 ...
 * Upgraded runtime Dart SDK to `3.12.0`
 * Upgraded dependencies (including: `appengine`, `gcloud`, `googleapis`, `typed_sql`).

## `20260519t092000-all`
 * Bump runtimeVersion to `2026.05.19`.
 * Upgraded stable Dart analysis SDK to `3.12.0`
 * Upgraded stable Flutter analysis SDK to `3.44.0`.
 ...
 * Temp fix of https://github.com/dart-lang/pub/issues/4813
...
## `20260423t074100-all`
 * Bump runtimeVersion to `2026.04.20`.
 * Upgraded stable Dart analysis SDK to `3.11.5`
 * Upgraded stable Flutter analysis SDK to `3.41.7`.
 ...
 * Bump runtimeVersion to `2026.04.07`.
 ...
 * Upgraded pana to `0.23.11`.
 * Note: Started blocking new uploads without `README.md`.

## `20260312t144500-all`
 * Bump runtimeVersion to `2026.03.10`.
 * Upgraded stable Dart analysis SDK to `3.11.2`
 * Upgraded stable Flutter analysis SDK to `3.41.4`.
 * Note: Updated the scaling settings of the `search` service instances.

## `20260306t095100-all`
 * Bump runtimeVersion to `2026.03.06`.
 * Upgraded dartdoc to `9.0.4`.
 * Note: Updated the scaling settings of the `search` service instances.

## `20260303t103500-all`
 * Bump runtimeVersion to `2026.03.02`.
 * Upgraded dependencies (incl. `analyzer`)

## `20260226t084100-all`
 * Bump runtimeVersion to `2026.02.24`.
 * Upgraded runtime Dart SDK to `3.11.0`
 * Upgraded stable Dart analysis SDK to `3.11.1`
 * Upgraded stable Flutter analysis SDK to `3.41.2`.
 * Upgraded dartdoc to `9.0.3`.
 * Upgraded dependencies (incl. `mailer`, `tar`)

## `20260218t105500-all`
 * Bump runtimeVersion to `2026.02.17`.
 * Upgraded stable Flutter analysis SDK to `3.41.0`.
 * Upgraded pana to `0.23.10`.
 ...
 * Note: `pub_worker` started to use AOT-compiled `pub_worker_subprocess`.

## `20260203t095200-all`
 * Bump runtimeVersion to `2026.01.30`.
 * Note: enabled sandbox subprocess.

## `20260129t124200-all`
 * Bump runtimeVersion to `2026.01.29`.
 * Note: reverted sandbox subprocess.

## `20260129t090900-all`
 * Bump runtimeVersion to `2026.01.28`.
 * Upgraded stable Dart analysis SDK to `3.10.8`
 * Upgraded stable Flutter analysis SDK to `3.38.8`.
 ...
 * Upgraded stable Flutter analysis SDK to `3.38.6`.
 * Upgraded dartdoc to `9.0.1`.

## `20260106t123700-all`
 * Bump runtimeVersion to `2026.01.06`.
 * Upgraded stable Dart analysis SDK to `3.10.7`
 * Upgraded pana to `0.23.5`.

## `20260105t122700-all`
 * Bump runtimeVersion to `2026.01.05`.
 * Upgraded stable Flutter analysis SDK to `3.38.5`.
 * Increased the memory of the `search` service instances.
 * Upgraded pana to `0.23.4`.
 ...
 * Upgraded stable Flutter analysis SDK to `3.38.1`.
 * Upgraded pana to `0.23.2`.

## `20251113t111200-all`
 * Bump runtimeVersion to `2025.11.13`.
 * Upgraded stable Dart analysis SDK to `3.10.0`
 * Upgraded stable Flutter analysis SDK to `3.38.0`.
